...
module integrator
	...
	real(8), parameter :: trpower = 4
		...
		! it returns an array of 2 real numbers:
		! 1 -- the number density of dust grains on bound (elliptic) orbits
		...
		! 1-3 -- a 3d vector of grains velocity averaged over the grains
		! moving upward
		! 4-6 -- a 3d vector of grains velocity averaged over the grains
		! moving downward
		! 7 -- the number density of the dust grains moving upward
